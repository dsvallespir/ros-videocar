...
def control(key):
    ...
    # global img, img_count
        ...
        #if key == ord('x'):
        #    filename = "smartcar_" + str(img_count) + ".png"
        #    cv.imwrite(filename,img)
        #    img_count = img_count + 1
        #   print(time_stamp() + ' ' + 'Screenshot tomada: ' + filename );

        #if key == ord('q'):
        #    print(time_stamp() + ' ' + str(ser.readline()))
        #if key == ord('z'):
        #    print(time_stamp() + ' ' + 'Terminando la aplicación...');
        #    cap.release()
